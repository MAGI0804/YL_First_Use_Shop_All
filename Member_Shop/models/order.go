...
type Order struct {
	...
	CreatedByBackend   bool       `gorm:"column:created_by_backend;default:false;comment:是否后台代下单" json:"created_by_backend"`
	BackendOperatorID  uint       `gorm:"column:backend_operator_id;default:0;comment:后台代下单操作人ID" json:"backend_operator_id"`
	BackendOrderRemark string     `gorm:"column:backend_order_remark;type:text;null;comment:后台代下单备注" json:"backend_order_remark"`
