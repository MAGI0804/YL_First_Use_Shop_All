...
| 2026-06-03 | develop | complete week 2-5 base repairs | 第二-三周基础修复续：数据分析改用最终实付金额；第四-五周基础修复：库存日志类型、调拨、盘点、Web 库存管理页面 | `go test ./...`、`npm run build` 通过 | 待推送到 `origin/develop` |
